...
Todas estas relações podem ser observadas na matriz de correlação abaixo:
...
A partir da visualização da matriz de correlação, escolhemos as seguintes variáveis para avaliarmos seus gráficos de dispersão e valores dos coeficientes e correlação: **Price**, **Bathrooms**, **Sqft_living**, **Grade**, **Sqft_above**, **Sqft_living_15**.
